...
float UMelee_LR::Execute()
{
	...
	if (DistanceToPlayer > AttackRadius)
	{
		...
		GetWorld()->GetTimerManager().SetTimer(PreAttackTimerHandle, this, &UMelee_LR::MoveTowardsPlayer, PreAttackAnimDuration,
											   false);
	...
	else if (DistanceToPlayer != 0.0f)
	{
		...
		GetWorld()->GetTimerManager().SetTimer(AttackTimerHandle, this, &UMelee_LR::FinishAttackTask, AttackAnimDuration,
												   false);
